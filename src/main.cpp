...
int main() {
    ...
    std::vector<std::shared_ptr<Triangle>> walls = {    
        ...
        // Front walls
        std::make_shared<Triangle>(Triangle{ vec4(10.0,-6.0, 5.0, 1.0), vec4(13.0, 0.0, 5.0, 1.0), vec4(10.0,-6.0,-5.0, 1.0), BLUE, SurfaceType::MIRROR }),
        std::make_shared<Triangle>(Triangle{ vec4(13.0, 0.0, 5.0, 1.0), vec4(13.0, 0.0,-5.0, 1.0), vec4(10.0,-6.0,-5.0, 1.0), BLUE, SurfaceType::MIRROR }),
        std::make_shared<Triangle>(Triangle{ vec4(10.0, 6.0, 5.0, 1.0), vec4(13.0, 0.0,-5.0, 1.0), vec4(13.0, 0.0, 5.0, 1.0), CYAN, SurfaceType::MIRROR }),
        std::make_shared<Triangle>(Triangle{ vec4(10.0, 6.0, 5.0, 1.0), vec4(10.0, 6.0,-5.0, 1.0), vec4(13.0, 0.0,-5.0, 1.0), CYAN, SurfaceType::MIRROR }),
        // Back walls
